# coding=utf-8
# Adapted from
# https://github.com/NVlabs/GaussianSTORM/blob/main/preproc/utils.py
...
# NOTE: This file has similar content to multiprocess_utils.py but is kept separate
# to maintain traceability to different upstream sources (GaussianSTORM vs DriveDreamer4D)
import sys
import time
