# coding=utf-8
# Adapted from
# https://github.com/NVlabs/GaussianSTORM/blob/main/storm/dataset/samplers.py
...
class InfiniteSampler(Sampler):
    ...
    def _iterator(self):
        ...
        if self._shuffle:
            raise RuntimeError("_iterator called when shuffle is True")
        while True:
    ...
    def _shuffled_iterator(self):
        ...
        if not self._shuffle:
            raise RuntimeError("_shuffled_iterator called when shuffle is False")
