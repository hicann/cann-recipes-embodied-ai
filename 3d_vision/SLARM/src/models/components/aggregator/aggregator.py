# coding=utf-8
# Adapted from
# https://github.com/NIRVANALAN/STream3R/blob/main/stream3r/models/components/aggregator/streamaggregator.py

# Copyright (c) 2026, Huawei Technologies Co., Ltd. All rights reserved.
# Copyright (c) S-Lab and Meta Platforms, Inc. and affiliates. All rights reserved.
...
class Aggregator(nn.Module):
    ...
    @property
    def resnet_mean(self):
        """Get the resnet mean normalization value (public interface)."""
        return self._resnet_mean

    @property
    def resnet_std(self):
        """Get the resnet std normalization value (public interface)."""
        return self._resnet_std
