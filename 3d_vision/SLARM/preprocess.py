# coding=utf-8
# Adapted from
# https://github.com/NVlabs/GaussianSTORM/blob/main/preprocess.py
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="training",
        help=("split of the dataset, e.g. training, validation, "
              "testing, please specify the split name for different dataset"),
    )
    parser.add_argument(
        "--target_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        help=("scene ids to be processed, a list of integers separated by space. "
              "Range: [0, 798] for training, [0, 202] for validation"),
    )
    parser.add_argument(
        "--start_idx",
        type=int,
    ...
    if args.scene_list_file is None:
        raise ValueError("scene_list_file is required")
    ...
    logger.info(f"scene_lists: {scene_lists}")
    ...
    if args.dataset == "waymo":
        ...
        raise ValueError(
            f"Unknown dataset {args.dataset}, please choose from waymo"
        )
